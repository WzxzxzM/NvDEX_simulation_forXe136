...
class TRestReadoutPixel : public TObject {
   private:
    ...
    Bool_t fIsStrip;  ///< The type of the readout : false is pixel, true is strip;
   ...
   public:
    ...
    Bool_t GetStrip() const { return fIsStrip; }
    ...
    void SetStrip(Bool_t type) { fIsStrip = type; }
