...
#pragma region SetupDecodingFile
            ...
            cout << fModuleDefinitions[mid].GetNumberOfChannels() << endl;
...
#pragma region addPixel
        ...
        while ((pixelString = GetKEYDefinition("addPixel", position3, channelString)) != "") {
            ...
            pixel.SetStrip(StringToBool(GetFieldValue("strip", pixelString)));
        ...
        //     }
        // }
        // cout << channel.GetNumberOfPixels() << " : " << pixelVector.size() << endl;
