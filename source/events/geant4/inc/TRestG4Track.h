...
public:
    ...
    void AddG4Hit(TVector3 pos, Double_t en, Int_t pcs, Int_t vol, Double_t pre_en, Double_t pos_en)
    {
        fHits.AddG4Hit(pos, en, pcs, vol, pre_en, pos_en);
    }
    void AddG4Hit(TVector3 pos, Double_t en, Int_t pcs, Int_t vol, Double_t pre_en, Double_t pos_en, Double_t time)
    {
        fHits.AddG4Hit(pos, en, pcs, vol, pre_en, pos_en, time);
    }
    ...
    void RemoveHits() { fHits.RemoveG4Hits(); }
    ...
    {
        for (int n = 0; n < GetHits()->GetNumberOfHits(); n++)
            if ((GetHits()->GetHitProcess(n) == 11) && (GetHits()->GetHitVolume(n)) == volID)
                return true;
        return false;
    }
    ...
    {
        for (int n = 0; n < GetHits()->GetNumberOfHits(); n++)
            if ((GetHits()->GetHitProcess(n) == 3) && (GetHits()->GetHitVolume(n)) == volID)
                return true;
        return false;
    }
    ...
    {
        for (int n = 0; n < GetHits()->GetNumberOfHits(); n++)
            if ((GetHits()->GetHitProcess(n) == 42) && (GetHits()->GetHitVolume(n)) == volID)
                return true;
        return false;
    }
    ...
    {
        for (int n = 0; n < GetHits()->GetNumberOfHits(); n++)
            if ((GetHits()->GetHitProcess(n) == 7) && (GetHits()->GetHitVolume(n)) == volID)
                return true;
        return false;
    }
    ...
    {
        for (int n = 0; n < GetHits()->GetNumberOfHits(); n++)
            if ((GetHits()->GetHitProcess(n) == 5) && (GetHits()->GetHitVolume(n)) == volID)
                return true;
        return false;
    }
    ...
    {
        for (int n = 0; n < GetHits()->GetNumberOfHits(); n++)
            if ((GetHits()->GetHitProcess(n) == 38) && (GetHits()->GetHitVolume(n)) == volID)
                return true;
        return false;
    }
    ...
    {
        for (int n = 0; n < GetHits()->GetNumberOfHits(); n++)
            if ((GetHits()->GetHitProcess(n) == 33) && (GetHits()->GetHitVolume(n)) == volID)
                return true;
        return false;
    }
    ...
    {
        for (int n = 0; n < GetHits()->GetNumberOfHits(); n++)
            if ((GetHits()->GetHitVolume(n) == volID) && (GetParticleName() == "neutron"))
                return true;
        return false;
    }
    ...
    {
        for (int n = 0; n < GetHits()->GetNumberOfHits(); n++)
            if ((GetHits()->GetHitVolume(n) == volID) && (GetParticleName().Contains("Ar")))
                return true;
        return false;
    }
    ...
    {
        for (int n = 0; n < GetHits()->GetNumberOfHits(); n++)
            if ((GetHits()->GetHitVolume(n) == volID) && (GetParticleName().Contains("Ne")))
                return true;
        return false;
    }
    ...
    {
        for (int n = 0; n < GetHits()->GetNumberOfHits(); n++)
            if ((GetHits()->GetHitVolume(n) == volID) && (GetParticleName().Contains("Xe")))
                return true;
        return false;
    }
    /////////////////////////////////
